"""
export_ms_blocks_2346.py

Exports a full-year, day-by-day list of ONLY Middle School Blocks 2, 3, 4,
and 6 (MS-2, MS-3, MS-4, MS-6), with start/end times. This is a narrowed
version of export_ms_block_calendar.py — same underlying data and join
logic, just a smaller whitelist.
...
Usage:
    python export_ms_blocks_2346.py --start 2026-08-01 --end 2027-06-30 --out ms_blocks_2346.csv
"""
...
# Only these four blocks — Middle School Blocks 2, 3, 4, and 6.
